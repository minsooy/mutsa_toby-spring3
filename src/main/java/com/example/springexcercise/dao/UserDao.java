...
public class UserDao {
    ...
    private Connection getConnection(String dbHost, String dbUser, String dbPassword) throws ClassNotFoundException, SQLException {
    ...
    public void add(User user) throws ClassNotFoundException, SQLException {
        ...
        Connection conn = getConnection(dbHost, dbUser, dbPassword);
